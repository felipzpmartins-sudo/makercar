  ...
  return (
    <section id="inicio" className="scroll-mt-24">
      ...
      <div className="relative overflow-hidden rounded-lg border border-border bg-card p-6 shadow-sm sm:p-8">
        <div
          className="absolute right-5 top-5 z-20 flex min-w-24 max-w-[calc(100%-2.5rem)] items-center justify-center gap-2 rounded-full bg-card/85 px-3 py-1 text-center text-xs font-medium text-foreground ring-1 ring-border backdrop-blur"
          title={statusLabel}
        >
        ...
        <div className="grid items-center gap-8 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="relative flex min-h-[330px] items-end justify-center overflow-hidden rounded-lg bg-muted">
            <div className="absolute bottom-12 left-1/2 h-10 w-72 -translate-x-1/2 rounded-[50%] bg-foreground/15 dark:bg-black/40 blur-2xl" />
            <img
          ...
          <div className="space-y-5">
            <div>
              <p className="text-xs font-semibold uppercase text-primary">Veículo em destaque</p>
