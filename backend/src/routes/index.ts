...
import { equipmentReservationsRoutes } from "./equipment-reservations.routes.js";
import { equipmentRoutes } from "./equipment.routes.js";
import { eventsRoutes } from "./events.routes.js";
import { meetingRoomReservationsRoutes } from "./meeting-room-reservations.routes.js";
import { meetingRoomsRoutes } from "./meeting-rooms.routes.js";
...
routes.use("/equipment-reservations", equipmentReservationsRoutes);
routes.use("/rooms", meetingRoomsRoutes);
routes.use("/room-reservations", meetingRoomReservationsRoutes);
